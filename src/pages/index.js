...
<Container>
  ...
  <div class="course-card">
    ...
    <Col lg={4} md={6} sm={12}>
      ...
      backgroundImage: "url(https://ghfoodsmenurecipes.files.wordpress.com/2016/05/aaeaaqaaaaaaaayjaaaajdhlyzazngexltm0nwqtndfhoc1izmi0lwrjytczmtixztkyna.jpg)"}}>
      <div>
      </div>
      </Link>
    </Col>
    ...
    <Col lg={4} md={6} sm={12}>
      <Link className="bard" to="/OTHER%20COURSES" style={{ textDecoration: "none" ,
      backgroundImage: "url(https://5.imimg.com/data5/CU/HQ/GLADMIN-6415379/desktop-publishing-training-250x250.png)"}}>
      <div>
      </div>
      </Link>
    </Col>
